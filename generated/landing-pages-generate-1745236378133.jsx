    ...
    <div className="min-h-screen font-sans">
      ...
      >
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <button className="bg-white text-black px-8 py-4 font-bold uppercase hover:bg-opacity-90 transition">
            GENERATE YOUR OWN
          </button>
        </div>
      </section>
      ...
      <section id="section1" className="py-20 bg-gradient-to-r from-indigo-500 to-purple-600">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
            ...
            <button className="bg-white text-indigo-600 px-6 py-3 font-bold uppercase hover:bg-opacity-90 transition">
              CREATE NOW
            </button>
          </div>
          <div className="md:w-1/2">
            <img 
              src="https://via.placeholder.com/800x400?text=Image+Placeholder" 
              alt="Section 1" 
      ...
      <section id="section2" className="py-20 bg-gray-100">
        <div className="container mx-auto px-4 flex flex-col md:flex-row-reverse items-center">
          <div className="md:w-1/2 mb-10 md:mb-0 md:pl-10">
            ...
            <button className="bg-black text-white px-6 py-3 font-bold uppercase hover:bg-opacity-90 transition">
              CREATE YOUR OWN NOW!
            </button>
          </div>
          <div className="md:w-1/2">
      ...
      <section id="section3" className="py-20 bg-white">
        <div className="container mx-auto px-4 flex flex-col items-center text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl">Get starerd righr now</p>
          <img 
            src="https://via.placeholder.com/800x400?text=Image+Placeholder" 
            alt="Section 3" 
            className="rounded-lg shadow-xl mb-8 w-full max-w-2xl"
          />
          <button className="bg-blue-600 text-white px-6 py-3 font-bold uppercase hover:bg-opacity-90 transition">
            CREATE NOW
          </button>
        </div>
      </section>
